...
namespace Common
{
    //PredictedSimulationSystemGroup if we want it to run on both the Client and the Server
    ...
    public partial class CountdownToGameStartSystem : SystemBase
    {
        ...
        protected override void OnUpdate()
        {
            ...
            foreach (var (gameStartTick, entity) 
                     in SystemAPI.Query<GameStartTick>().WithAll<Simulate>().WithEntityAccess())
            {
